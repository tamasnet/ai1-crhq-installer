...
// directly (env INSTALL_SCHEMA/SKILLS_BASE_DIR must already be set by provisionSandbox).
...
export function makeCtx(over = {}) {
  return {
    db: getDb(), SKILLS_BASE: process.env.SKILLS_BASE_DIR, BRAINS: process.env.AGENT_BRAINS_DIR,
